...
public class PlayScene extends Scene<PongGame> {
	...
	@Override
	public void init() {
		court = Entities.findAny(Court.class);
		switch (getApp().getPlayMode()) {
		case Computer_Computer:
			paddleLeft = Entities.findAny(AutoPaddleLeft.class);
			paddleRight = Entities.findAny(AutoPaddleRight.class);
			break;
		case Computer_Player2:
			paddleLeft = Entities.findAny(AutoPaddleLeft.class);
			paddleRight = Entities.findByName(Paddle.class, "paddleRight");
			break;
		case Player1_Computer:
			paddleLeft = Entities.findByName(Paddle.class, "paddleLeft");
			paddleRight = Entities.findAny(AutoPaddleRight.class);
			break;
		...
		ball = Entities.findAny(Ball.class);
		score = Entities.findAny(ScoreDisplay.class);
