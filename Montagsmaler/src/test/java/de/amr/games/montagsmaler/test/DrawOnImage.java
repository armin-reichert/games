...
/**
 * Note: Normally the ButtonPanel and DrawingArea would not be static classes. This was done for the
 * convenience of posting the code in one class and to highlight the differences between the two
 * approaches. All the differences are found in the DrawingArea class.
 */
