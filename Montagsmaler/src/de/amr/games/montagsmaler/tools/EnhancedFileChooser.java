  ...
  private static class ImagePreviewPanel extends JPanel implements PropertyChangeListener {
    ...
    @Override
      ...
      if (propertyName.equals(JFileChooser.SELECTED_FILE_CHANGED_PROPERTY)) {
        ...
        /*
         * Make reasonably sure we have an image format that AWT can handle so
         * we don't try to draw something silly.
         */
    ...
    @Override
       ...
       * if they have larger sizes than the one we are currently drawing. Also,
       * it seems that the file list can paint outside of its rectangle, and
       * will cause odd behavior if we don't clear or fill the rectangle for the
