...
/**
 * A drawing canvas with the capability of scrolling its content (text and images) smoothly from the
 * bottom to the top.
 */
public class ScrollingCanvas extends DrawingCanvas implements ActionListener {
	...
	/**
	 * Should be overridden by subclasses and use the {@link #text(String)} and {@link #image(Image)}
	 * methods to compose the content to be scrolled.
	 */
